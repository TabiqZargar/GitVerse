    ...
    >
      <div className="flex items-center gap-unit-md">
        ...
        <div className="hidden md:flex gap-unit-lg ml-unit-xl">
          ...
          <Link href="/universe" className="text-primary font-bold border-b-2 border-primary pb-1">Universe</Link>
      ...
      <div className="flex items-center gap-unit-md">
        <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }} className="material-symbols-outlined text-on-surface-variant hover:text-primary cursor-pointer">notifications</motion.button>
        <div className="w-8 h-8 rounded-full bg-primary/20 border border-primary/40 flex items-center justify-center overflow-hidden">
          <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuC2vDjGouC4n1coSVtqrkX_lLMi2XTPNItxqy4H0O1VQOm6H3tY1K5ardRFyafipyks8vXPLu5xQGjJaKIdU8qZ3PFN_J9DCQtB0vA7eCvWBn0qdCvLVMMdpzviziGTPq7FGE7W1AmyUeG3Y9BXAR7MRXGtpSANlgyW6VET7ezqK7DXhXc20Vdnr7o5MKL3nw-YEOAQsEokMc0X2VI1aq7VB-nG_qX2yFVKLdkJTpDHtS5xdWTGQ_pm_-2tJEwCz2WGZSwASQWA9LA" alt="Profile" className="w-full h-full object-cover" />
        </div>
      </div>
    </motion.nav>
  );
